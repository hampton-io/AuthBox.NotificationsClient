...
describe('when sending an access request email', () => {
  ...
  test('then it should create queue connecting to provided connection string', async () => {
    await client.sendAccessRequest(email, firstName, lastName, orgName, approved, reason);
  ...
  test('then it should resolve if there is no error', async () => {
    await expect(client.sendAccessRequest(email, firstName, lastName, orgName, approved, reason)).resolves.toBeUndefined();
  });
  ...
  test('then it should reject if there is an error', async () => {
    ...
    await expect(client.sendAccessRequest(email, firstName, lastName, orgName, approved, reason)).rejects.toBeDefined();
  });
