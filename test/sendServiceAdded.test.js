...
describe('when sending an service added email', () => {
  ...
  test('then it should create queue connecting to provided connection string', async () => {
    await client.sendServiceAdded(email, firstName, lastName, orgName, serviceName);
  ...
  test('then it should create job with data including serviceName', async () => {
    await client.sendServiceAdded(email, firstName, lastName, orgName, serviceName);
  ...
  test('then it should reject if there is an error', async () => {
    ...
    await expect(client.sendServiceAdded(email, firstName, lastName, orgName, serviceName)).rejects.toBeDefined();
  });
