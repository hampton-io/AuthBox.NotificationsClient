...
class NotificationClient {
  ...
  async sendSupportRequest(name, email, saUsername, phone, service, type, message, reference) {
    await send('supportrequest_v1', { name, email, saUsername, phone, service, type, message, reference }, this.connectionString);
  }
