...
class NotificationClient {
  ...
  async sendExistingUserInvitation(email, firstName, lastName, serviceName, returnUrl) {
    await send('existinguserinvitation_v1', { email, firstName, lastName, serviceName, returnUrl }, this.connectionString);
  }
