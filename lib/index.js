...
class NotificationClient {
  ...
  async sendSupportRequest(name, email, phone, service, type, message, reference, saUsername, orgName, urn) {
    await send('supportrequest_v1', { name, email, phone, service, type, message, reference, saUsername, orgName, urn }, this.connectionString);
  }
