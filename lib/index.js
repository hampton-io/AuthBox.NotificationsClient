...
class NotificationClient {
  ...
  async sendAccessRequest(email, firstName, lastName, orgName, approved, reason) {
    await send('accessrequest_v1', {email, firstName, lastName, orgName, approved, reason}, this.connectionString);
  }
}
