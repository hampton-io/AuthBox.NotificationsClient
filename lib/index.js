...
class NotificationClient {
  ...
  async sendSupportRequest(name, email, phone, service, type, message, reference, orgName, urn) {
    await send('supportrequest_v1', { name, email, phone, service, type, message, reference, orgName, urn }, this.connectionString);
  }
  ...
  async sendServiceAdded(email, firstName, lastName, orgName, serviceName) {
    await send('userserviceadded_v1', {email, firstName, lastName, orgName, serviceName}, this.connectionString);
  }
}
